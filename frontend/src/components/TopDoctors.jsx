...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-6 my-20 text-neutral-800 md:mx-10'>
            ...
            <button onClick={() => { navigate('/doctors'); scrollTo(0, 0) }} className='bg-primary-light text-primary-dark px-12 py-4 rounded-full mt-12 font-medium hover:bg-primary hover:text-white transition-all duration-300 shadow-sm'>View More</button>
        </div>
