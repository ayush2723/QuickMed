...
const Header = () => {
    return (
        <div className='flex flex-col md:flex-row flex-wrap bg-gradient-to-r from-primary to-primary-dark rounded-2xl px-8 md:px-12 lg:px-24 shadow-lg'>
            ...
            <div className='md:w-1/2 flex flex-col items-start justify-center gap-6 py-12 m-auto md:py-[10vw] md:mb-[-30px]'>
                ...
                <a href='#speciality' className='flex items-center gap-3 bg-white px-8 py-4 rounded-full text-neutral-700 text-sm font-medium m-auto md:m-0 hover:shadow-lg hover:scale-105 transition-all duration-300'>
